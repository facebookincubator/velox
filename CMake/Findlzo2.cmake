...
find_library(LZO2_LIBRARY_RELEASE lzo2
  PATHS $LZO2_LIBRARYDIR})
find_library(LZO2_LIBRARY_DEBUG lzo2d
  PATHS ${LZO2_LIBRARYDIR})

find_path(LZO2_INCLUDE_DIR lzo/lzo1a.h
  PATHS ${LZO2_INCLUDEDIR})
...
if (NOT TARGET lzo2::lzo2)
  ...
  set_target_properties(lzo2::lzo2 PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES "C" IMPORTED_LOCATION "${LZO2_LIBRARIES}")
endif()
