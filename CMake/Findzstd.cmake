...
# zstd::zstd_static|shared willbe defined if found

include(FindPackageHandleStandardArgs)
include(SelectLibraryConfigurations)

find_library(ZSTD_LIBRARY_RELEASE zstd
  PATHS $ZSTD_LIBRARYDIR})
find_library(ZSTD_LIBRARY_DEBUG zstdd
  PATHS ${ZSTD_LIBRARYDIR})

find_path(ZSTD_INCLUDE_DIR zstd.h
  PATHS ${ZSTD_INCLUDEDIR})
...
if (NOT TARGET zstd::zstd)
  ...
  set_target_properties(zstd::zstd PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES "C" IMPORTED_LOCATION "${ZSTD_LIBRARIES}")
endif()
