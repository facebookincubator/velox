...
* Add query replayer for analyzing and debugging query performance. :pr:`10897`
...
* Add support for custom comparison functions in ContainerRowSerde, RowContainer, and VectorHasher. :pr:`11023`, :pr:`11024`, :pr:`11051`
* Add support for full outer join in SMJ (Sort Merge Join). :pr:`10247`
* Add batch version of RowContainer::store API for improved performance. :pr:`10812`
* Add spill metric spillExtractVectorTimeNanos for better monitoring. :pr:`11049`
* Fix right join result mismatch issue. :pr:`11027`
...
* Fix casting of varchar to integral types by trimming unicode and control characters. :pr:`10957`
* Fix TRY_CAST(VARCHAR as TIMESTAMP) incorrectly suppress errors of input outside supported ranges. :pr:`10928`
...
* Add support for custom comparison in Presto's IN function. :pr:`11032`
...
* Fix invalid UTF-8 character in Spark translate function. :pr:`10891`
* Handle Multi-Char delims in :spark:func:`split_to_map` function. :pr:`10861`

Connectors
==========

* Fix ParquetReader initialize schema failed for ARRAY/MAP column. :pr:`10681`
* Fix the issue of inaccurate statistical data for parquet-251. :pr:`10823`
* Enable reading explicit row number column from Prism connector. :pr:`11072`
* Add S3FileSystem CRC32 checksum support on AWS S3. :pr:`10918`
* Add config to use selective Nimble reader. :pr:`10990`
* Extend filesystem APIs for improved functionality. :pr:`10504`

Performance and Correctness
===========================

* Add query configs to turn off expression evaluation optimizations. :pr:`10902`
* Add support for smallint to PrefixSort for improved sorting performance. :pr:`10946`
* Allow pushdown of dynamic filters through HashAggregation. :pr:`10988`
* Optimize duplicate row memory allocations. :pr:`10865`
* Enable Parquet LazyVector support for better memory efficiency. :pr:`11010`
* Enable more test cases for serial execution mode in SharedArbitratorTest. :pr:`10916`
* Enable probe spill with dynamic filter replaced. :pr:`10849`
* Ignore time zones that are not recognizable by OS when building time zone database. :pr:`10654`
