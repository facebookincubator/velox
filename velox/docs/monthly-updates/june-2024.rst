...
* Add support for DECIMAL :func:`modulus` function.
...
* Add support for DATETIME unit 'week' in :func:`date_add` and :func:`date_diff`.
* Add support for TIMESTAMP input in :func:`to_iso8601`.
* Add support for variable pattern and replacement in :func:`regexp_replace`.
...
* Add "cache.no_retention" session config to allow a query to not retain data in the
  AsyncDataCache and skip SSD Cache.
