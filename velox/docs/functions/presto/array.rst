...
.. function:: array_cum_sum(array(T)) -> array(T)
    ...
    The following types are supported for T (the element type of the input array): int8_t, int16_t, int32_t, int64_t,
    int128_t, float, double, ShortDecimal, and LongDecimal. ::
