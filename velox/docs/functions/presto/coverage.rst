...
.. table::
    ...
    :func:`array_max_by`                      :func:`exp`                               key_sampling_percent                      rgb                                       :func:`st_xmin`                               :func:`convex_hull_agg`
    ...
    :func:`array_top_n`                       fnv1_32                                   :func:`localtime`                         :func:`sha256`                            tdigest_agg                                   :func:`geometric_mean`
    :func:`array_union`                       fnv1_64                                   localtimestamp                            :func:`sha512`                            :func:`timezone_hour`                         :func:`geometry_union_agg`
    :func:`arrays_overlap`                    fnv1a_32                                  :func:`log10`                             :func:`shuffle`                           :func:`timezone_minute`                       :func:`histogram`
    :func:`asin`                              fnv1a_64                                  :func:`log2`                              :func:`sign`                              :func:`to_base`                               :func:`khyperloglog_agg`
