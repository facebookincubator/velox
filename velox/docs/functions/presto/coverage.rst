...
.. table::
    ...
    :func:`bitwise_right_shift`               :func:`google_polyline_decode`            :func:`millisecond`                       :func:`st_dimension`                      :func:`url_encode`                            :func:`reduce_agg`
    :func:`bitwise_right_shift_arithmetic`    :func:`google_polyline_encode`            :func:`minute`                            :func:`st_disjoint`                       :func:`url_extract_fragment`                  :func:`regr_avgx`
