...
.. function:: murmur3_x64_128(binary) -> varbinary
    ...
    Computes a 128-bit hash of ``binary`` that is equivalent to the 128-bit
    MurmurHash3 algorithm, as defined by the original C++ reference
    implementation (often called MurmurHash3_x64_128 or Murmur3F).
