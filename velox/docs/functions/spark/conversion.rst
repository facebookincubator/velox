...
* ``true`` is cast to **1970-01-01 00:00:00.000001**
* ``false`` is cast to **1970-01-01 00:00:00** (epoch)

This behavior matches Spark's semantics for boolean-to-timestamp casts.
