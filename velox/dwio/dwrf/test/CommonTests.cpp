...
TEST_F(
    CommonTest,
    dwrfStreamIdentifierGetFormatWithStreamTypesGetCorrectFormat) {
  EXPECT_EQ(
...
TEST_F(CommonTest, dwrfStreamIdentifierWithDwrfStreamGetCorrectInfo) {
...
TEST_F(CommonTest, dwrfStreamIdentifierWithOrcStreamGetCorrectInfo) {
  auto streamId = DwrfStreamIdentifier(
...
TEST_F(
    CommonTest,
    dwrfStreamIdentifierGetKindWithAllStreamKindsGetCorrectConversion) {
  // DWRF
