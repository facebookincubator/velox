...
class ReaderBase {
 public:
  ...
  std::unique_ptr<dwio::common::SeekableInputStream> createDecompressedStream(
      ...
      dwio::common::ColumnStats* columnStats = nullptr) const {
  ...
  columnReaderStatistics() const {
    return columnReaderStatistics_;
  }
 ...
 private:
  ...
  // Column reader statistics, including file footer decompression time.
