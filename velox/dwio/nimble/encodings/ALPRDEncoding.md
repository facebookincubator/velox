...
decoding lifecycles are validated bit-for-bit before timing. See the
[benchmark guide](benchmarks/ALPRDBenchmark.md) for reproducible commands, the
exact timing boundaries and differences from the paper's kernel benchmarks.
