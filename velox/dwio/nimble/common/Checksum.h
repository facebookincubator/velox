...
class Checksum {
 public:
  ...
  /// Narrows getChecksum() to 32 bits. Implementations own the narrowing
  ...
  virtual uint64_t computeChecksum(std::string_view data) = 0;

  /// Narrows computeChecksum() to 32 bits, under the same constraints as
  /// getChecksum32().
