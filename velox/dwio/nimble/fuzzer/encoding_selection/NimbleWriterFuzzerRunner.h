...
/// Registers the Nimble selective reader factory. Call once, after
/// velox::memory::MemoryManager::initialize and before
/// runNimbleWriterFuzzer().
void setUpFuzzerEnvironments();

/// Runs the writer fuzzer until --nimble_writer_fuzzer_duration_sec
...
/// is left unset a random one is chosen and logged so a failure can be
/// reproduced.
