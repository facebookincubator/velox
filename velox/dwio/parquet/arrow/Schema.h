...
class PARQUET_EXPORT Node {
 public:
  ...
  ConvertedType::type converted_type() const {
...
class PARQUET_EXPORT PrimitiveNode : public Node {
 public:
  ...
  ColumnOrder column_order() const {
    return column_order_;
  }

  void SetColumnOrder(ColumnOrder column_order) {
...
class PARQUET_EXPORT GroupNode : public Node {
 public:
  ...
  static inline NodePtr Make(
      ...
      int field_id = -1) {
    return NodePtr(
        new GroupNode(name, repetition, fields, converted_type, field_id));
  }
  ...
  static inline NodePtr Make(
      ...
      int field_id = -1) {
    return NodePtr(
        new GroupNode(name, repetition, fields, logical_type, field_id));
  }
...
class PARQUET_EXPORT ColumnDescriptor {
 public:
  ...
  ConvertedType::type converted_type() const {
    return primitive_node_->converted_type();
  }
  ...
  ColumnOrder column_order() const {
    return primitive_node_->column_order();
  }
...
class PARQUET_EXPORT SchemaDescriptor {
 public:
  ...
  const schema::NodePtr& schema_root() const {
    return schema_;
  }
