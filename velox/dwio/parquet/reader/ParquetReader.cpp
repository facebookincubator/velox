...
// whether the data should be interpreted as scalar values or array. If current
// schema element is a repeated field and the requested type is an array, we
// treat the current schema element as an unannotated array, and returns true if
// the element type is compatible with the physical type.
bool isCompatible(
