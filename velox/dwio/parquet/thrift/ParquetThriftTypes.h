...
// To resolve the conflict of redefinition of T_GLOBAL_LOGGING_LEVEL and
// T_LOG_OPER in both duckdb/parquet-amalgamation.hpp and thrift lib installed
// in arrow_ep
#ifdef T_GLOBAL_LOGGING_LEVEL
#undef T_GLOBAL_LOGGING_LEVEL
#endif
