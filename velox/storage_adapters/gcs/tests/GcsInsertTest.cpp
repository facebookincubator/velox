...
#include "velox/storage_adapters/gcs/tests/GcsEmulator.h"
#include "velox/storage_adapters/test_common/InsertTest.h"
...
class GcsInsertTest : public testing::Test, public test::InsertTest {
 protected:
  ...
  void SetUp() override {
    ...
    emulator_->bootstrap();
    InsertTest::SetUp(emulator_->hiveConfig(), ioExecutor_.get());
