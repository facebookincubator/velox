...
#include "velox/storage_adapters/s3fs/RegisterS3FileSystem.h" // @manual

#ifdef VELOX_ENABLE_S3
#include "velox/common/base/StatsReporter.h"
#include "velox/dwio/common/FileSink.h"
#include "velox/storage_adapters/s3fs/S3Config.h" // @manual
#include "velox/storage_adapters/s3fs/S3Counters.h" // @manual
#include "velox/storage_adapters/s3fs/S3FileSystem.h" // @manual
#include "velox/storage_adapters/s3fs/S3Util.h" // @manual
#endif
