...
class SparkQueryConfig {
 public:
  ...
  /// If true, encode accepts supported Java charset aliases.
  VELOX_SPARK_CONFIG(
      kLegacyJavaCharsets,
      legacyJavaCharsets,
      ...
      bool,
      false,
      "Allow supported Java charset aliases in the Spark encode function.")
  ...
  VELOX_SPARK_CONFIG(
      ...
      bool,
      false,
      "Replace unmappable characters in the Spark encode function.")
