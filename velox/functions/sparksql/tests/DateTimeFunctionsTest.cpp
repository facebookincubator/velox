...
TEST_F(DateTimeFunctionsTest, truncFunction) {
  ...
  VELOX_ASSERT_THROW(
      trunc("2025-02-15", "DD"),
      "DD is not a valid datetime unit field, minimum unit is week");
  VELOX_ASSERT_THROW(
      trunc("2025-02-15", "YYYYYYY"), "Unsupported datetime unit: YYYYYYY");
}
...
TEST_F(DateTimeFunctionsTest, dateTruncFunction) {
  ...
  EXPECT_EQ(
      ...
      parseTimestamp("2025-01-01 00:00:00.000"));
  VELOX_ASSERT_THROW(
      dateTrunc("YYYYYYY", "2025-02-15 12:05:30.127127"),
      "Unsupported datetime unit: YYYYYYY");
}
