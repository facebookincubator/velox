...
TEST_F(SparkCastExprTestAnsiOn, stringToTimestamp) {
  ...
  testInvalidCast<std::string>(
      "timestamp",
      {"2015-03-18 123142"},
      "Cannot cast VARCHAR '2015-03-18 123142' to TIMESTAMP. Unknown timezone value: \"123142\"");

  testInvalidCast<std::string>(
      "timestamp",
      {"2015-03-18X"},
      "Cannot cast VARCHAR '2015-03-18X' to TIMESTAMP. Unable to parse timestamp value: \"2015-03-18X\", expected format is (YYYY-MM-DD HH:MM:SS[.MS])");

  testInvalidCast<std::string>(
      "timestamp",
      {"abdef"},
      "Cannot cast VARCHAR 'abdef' to TIMESTAMP. Unable to parse timestamp value: \"abdef\", expected format is (YYYY-MM-DD HH:MM:SS[.MS])");
  */
...
TEST_F(SparkCastExprTestAnsiOn, timestampToInt) {
  ...
  testInvalidCast<Timestamp>(
      ...
      "Cannot cast TIMESTAMP '294247-01-10T04:00:56.000000000' to BIGINT. Could not convert Timestamp(9223372036856, 0) to microseconds");
      */
  testTimestampToInt();
}

TEST_F(SparkCastExprTestAnsiOn, doubleToTimestamp) {
  // Invalid double values should throw in ANSI mode
  /*
  testInvalidCast<double>(
      "timestamp",
      {kInf},
      "Cannot cast DOUBLE 'Infinity' to TIMESTAMP. Cannot cast NaN or Infinity to Timestamp");
  testInvalidCast<double>(
      "timestamp",
      {kNan},
      "Cannot cast DOUBLE 'NaN' to TIMESTAMP. Cannot cast NaN or Infinity to Timestamp");
  testInvalidCast<double>(
      "timestamp",
      {-kInf},
      "Cannot cast DOUBLE '-Infinity' to TIMESTAMP. Cannot cast NaN or Infinity to Timestamp");
...
TEST_F(SparkCastExprTestAnsiOn, floatToTimestamp) {
  // Invalid float values should throw in ANSI mode
  /*
  testInvalidCast<float>(
      "timestamp",
      {kInf},
      "Cannot cast REAL 'Infinity' to TIMESTAMP. Cannot cast NaN or Infinity to Timestamp");
  testInvalidCast<float>(
      "timestamp",
      {kNan},
      "Cannot cast REAL 'NaN' to TIMESTAMP. Cannot cast NaN or Infinity to Timestamp");
  testInvalidCast<float>(
      "timestamp",
      {-kInf},
      "Cannot cast REAL '-Infinity' to TIMESTAMP. Cannot cast NaN or Infinity to Timestamp");
...
TEST_F(SparkCastExprTestAnsiOn, primitiveInvalidCornerCase) {
  ...
  testInvalidCast<Timestamp>(
      "boolean",
      {Timestamp(1, 0)},
      "Cannot cast TIMESTAMP '1970-01-01T00:00:01.000000000' to BOOLEAN. Conversion of Timestamp to Boolean is not supported");
  testInvalidCast<bool>(
      "date", {true}, "Cast from BOOLEAN to DATE is not supported");

  // To floating-point - invalid strings should throw
  testInvalidCast<std::string>(
      "real",
      {"1.2a"},
      "Cannot cast VARCHAR '1.2a' to REAL. Non-whitespace character found after end of conversion: \"\"");
  testInvalidCast<std::string>(
      "real",
      {"1.2.3"},
      "Cannot cast VARCHAR '1.2.3' to REAL. Non-whitespace character found after end of conversion: \"\"");

  // To boolean - invalid strings should throw
  testInvalidCast<std::string>(
      "boolean",
      {"1.7E308"},
      "Cannot cast VARCHAR '1.7E308' to BOOLEAN. Cannot cast 1.7E308 to BOOLEAN");
  testInvalidCast<std::string>(
      "boolean",
      {"nan"},
      "Cannot cast VARCHAR 'nan' to BOOLEAN. Cannot cast nan to BOOLEAN");
  testInvalidCast<std::string>(
      "boolean",
      {"12"},
      "Cannot cast VARCHAR '12' to BOOLEAN. Cannot cast 12 to BOOLEAN");
  testInvalidCast<std::string>(
      "boolean",
      {"-1"},
      "Cannot cast VARCHAR '-1' to BOOLEAN. Cannot cast -1 to BOOLEAN");
  testInvalidCast<std::string>(
      "boolean",
      {"tr"},
      "Cannot cast VARCHAR 'tr' to BOOLEAN. Cannot cast tr to BOOLEAN");
  testInvalidCast<std::string>(
      "boolean",
      {"tru"},
      "Cannot cast VARCHAR 'tru' to BOOLEAN. Cannot cast tru to BOOLEAN");
  testInvalidCast<std::string>(
      "boolean",
      {"on"},
      "Cannot cast VARCHAR 'on' to BOOLEAN. Cannot cast on to BOOLEAN");
  testInvalidCast<std::string>(
      "boolean",
      {"off"},
      "Cannot cast VARCHAR 'off' to BOOLEAN. Cannot cast off to BOOLEAN");

  testInvalidCast<std::string>("tinyint", {"1.2"}, "");
  testInvalidCast<std::string>("tinyint", {"1.23444"}, "");
  testInvalidCast<std::string>("tinyint", {".2355"}, "");
  testInvalidCast<std::string>("tinyint", {"-1.8"}, "");
  testInvalidCast<std::string>("tinyint", {"1."}, "");
  testInvalidCast<std::string>("tinyint", {"-1."}, "");
  testInvalidCast<std::string>("tinyint", {"0."}, "");
  testInvalidCast<std::string>("tinyint", {"."}, "");
  testInvalidCast<std::string>("tinyint", {"-."}, "");

  testInvalidCast<int32_t>("tinyint", {1234567}, "");
  testInvalidCast<int32_t>("tinyint", {-1234567}, "");

  testInvalidCast<double>("tinyint", {12345.67}, "");
  testInvalidCast<double>("tinyint", {-12345.67}, "");
  testInvalidCast<float>("bigint", {kInf}, "");
  */
}
...
TEST_F(SparkCastExprTestAnsiOn, overflow) {
  // String overflow cases should throw in ANSI mode - Not enabled yet
  /*
  testInvalidCast<std::string>(
      "tinyint",
      {"166"},
      "Cannot cast VARCHAR '166' to TINYINT. Overflow during conversion: \"\"");
  testInvalidCast<std::string>(
      "tinyint",
      {"-166"},
      "Cannot cast VARCHAR '-166' to TINYINT. Negative overflow during conversion: \"\"");

  testInvalidCast<std::string>(
      "smallint",
      {"52769"},
      "Cannot cast VARCHAR '52769' to SMALLINT. Overflow during conversion: \"\"");
  testInvalidCast<std::string>(
      "smallint",
      {"-52769"},
      "Cannot cast VARCHAR '-52769' to SMALLINT. Negative overflow during conversion: \"\"");

  testInvalidCast<std::string>(
      "integer",
      {"17515055537"},
      "Cannot cast VARCHAR '17515055537' to INTEGER. Overflow during conversion: \"\"");
  testInvalidCast<std::string>(
      "integer",
      {"-17515055537"},
      "Cannot cast VARCHAR '-17515055537' to INTEGER. Negative overflow during conversion: \"\"");

  testInvalidCast<std::string>(
      "bigint",
      {"-9663372036854775809"},
      "Cannot cast VARCHAR '-9663372036854775809' to BIGINT. Negative overflow during conversion: \"\"");
  testInvalidCast<std::string>(
      "bigint",
      {"9663372036854775809"},
      "Cannot cast VARCHAR '9663372036854775809' to BIGINT. Overflow during conversion: \"\"");
      */
}
...
TEST_F(SparkCastExprTestAnsiOff, primitiveInvalidCornerCase) {
  ...
  // To integer - invalid strings return null
