...
#include "velox/functions/sparksql/detail/DecimalCeilFunction.h"

namespace facebook::velox::functions::sparksql {

// DecimalCeilFunction is implementation detail shared with the GPU path;
// only registerDecimalCeil() below is API.
using detail::DecimalCeilFunction;
