...
class SetDigest {
 public:
  ...
  int32_t estimatedSerializedSize();
...
inline int32_t SetDigest::estimatedSerializedSize() {
  int32_t hllSize = hllAccumulator_.serializedSize();
...
inline void SetDigest::deserialize(const char* data, int32_t size) {
  ...
  auto deserializedHll =
      common::hll::HllAccumulator<int64_t, true, HashStringAllocator>::
          deserialize(hllData, allocator_);
