...
TEST_F(QuantileDigestTest, getDistributionFunction) {
  ...
  QuantileDigest<int64_t, std::allocator<int64_t>> digest1(allocator, 0.01);
  for (int64_t i = 1; i <= 10; i++) {
    digest1.add(i, 1);
  }
  auto cdf1 = digest1.getDistributionFunction(0.0, 100.0);
  std::vector<int64_t> expectedCdfUpperBound = {
  ...
  QuantileDigest<int64_t, std::allocator<int64_t>> digest2(allocator, 0.01);
  for (int64_t i = 1; i <= 10; i++) {
    digest2.add(i, 1);
  }
  auto cdf2 = digest2.getDistributionFunction(5.0, 100.0);
  std::vector<int64_t> expectedCdfUpperBound2 = {5, 6, 7, 8, 9, 10, 100};
  ...
  // clip the range end.
  QuantileDigest<int64_t, std::allocator<int64_t>> digest3(allocator, 0.01);
  for (int64_t i = 1; i <= 10; i++) {
    digest3.add(i, 1);
  }
  auto cdf3 = digest3.getDistributionFunction(0.0, 5.0);
  std::vector<int64_t> expectedCdfUpperBound3 = {0, 1, 2, 3, 4, 5};
