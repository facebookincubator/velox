...
void registerSimpleFunctions(const std::string& prefix) {
  ...
  registerFunction<CurrentTimestampFunction, TimestampWithTimezone>({prefix + "current_timestamp"});
  registerFunction<CurrentTimestampFunction, TimestampWithTimezone>({prefix + "now"});
