...
TEST_F(SetDigestFunctionsTest, testCardinality) {
  ...
  facebook::velox::functions::SetDigest<int64_t, HashStringAllocator> digest(
      &allocator);
  ...
  facebook::velox::functions::SetDigest<int64_t, HashStringAllocator>
      digestWithDuplicates(&allocator);
...
TEST_F(SetDigestFunctionsTest, testIntersectionCardinality) {
  ...
  facebook::velox::functions::SetDigest<int64_t, HashStringAllocator> digest1(
      &allocator);
  for (int64_t i = 1; i <= 10; i++) {
    digest1.add(i);
  }

  facebook::velox::functions::SetDigest<int64_t, HashStringAllocator> digest2(
      &allocator);
  ...
  facebook::velox::functions::SetDigest<int64_t, HashStringAllocator> digest3(
      &allocator);
  ...
  expectedIntersection =
      facebook::velox::functions::SetDigest<int64_t, HashStringAllocator>::
          exactIntersectionCardinality(digest1, digest3);
  ...
  expectedIntersection =
      facebook::velox::functions::SetDigest<int64_t, HashStringAllocator>::
          exactIntersectionCardinality(digest1, digest1);
...
TEST_F(SetDigestFunctionsTest, testJaccardIndex) {
  ...
  facebook::velox::functions::SetDigest<int64_t, HashStringAllocator> digest4(
      &allocator);
  ...
  facebook::velox::functions::SetDigest<int64_t, HashStringAllocator> digest5(
      &allocator);
