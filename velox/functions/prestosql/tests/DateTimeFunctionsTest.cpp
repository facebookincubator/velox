...
TEST_F(DateTimeFunctionsTest, hashCodeOperators) {
  // Test that $operator$hash_code is registered and works correctly.
  // The hash_code operator is used by Presto for hash-based operations
  // like joins and statistics. It's an alias for xxhash64_internal.
  ...
  // Test Date type
  {
    ...
    auto hash0 = xxhash64(0); // 1970-01-01
    auto hash1 = xxhash64(18262); // 2020-01-01
    auto hash2 = xxhash64(-1); // 1969-12-31
    
    EXPECT_TRUE(hash0.has_value());
    ...
    EXPECT_EQ(xxhash64(18262), xxhash64(18262));
    EXPECT_EQ(xxhash64(0), xxhash64(0));
  ...
  // Test Timestamp type
  {
    ...
    auto hash0 = xxhash64(Timestamp(0, 0)); // Epoch
    auto hash1 = xxhash64(Timestamp(0, 1000000)); // 1ms after epoch
    auto hash2 = xxhash64(parseTimestamp("2023-05-15 12:30:45.123"));
    ...
    // Test determinism - same input produces same output
    auto ts = Timestamp(1609459200, 0);
    EXPECT_EQ(xxhash64(ts), xxhash64(ts));
  ...
  // Test Time type
  {
    ...
    auto hash0 = xxhash64(0); // Midnight
    auto hash1 = xxhash64(1); // 1ms after midnight
    auto hash2 = xxhash64(43200000); // Noon
    auto hash3 = xxhash64(86399999); // End of day
    ...
    // Test determinism - same input produces same output
    EXPECT_EQ(xxhash64(43200000), xxhash64(43200000));
