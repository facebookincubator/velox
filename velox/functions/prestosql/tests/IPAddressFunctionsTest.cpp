...
TEST_F(IPAddressFunctionsTest, ipPrefixFromIpAddress) {
  ...
  ASSERT_EQ(
      ...
      "::/0");
  EXPECT_THROW(
      ipPrefixFunctionFromIpAddress("::ffff:1.2.3.4", -1), VeloxUserError);
  EXPECT_THROW(
      ipPrefixFunctionFromIpAddress("::ffff:1.2.3.4", 33), VeloxUserError);
  EXPECT_THROW(
      ipPrefixFunctionFromIpAddress("64:ff9b::10", -1), VeloxUserError);
  EXPECT_THROW(
      ipPrefixFunctionFromIpAddress("64:ff9b::10", 129), VeloxUserError);
}
...
TEST_F(IPAddressFunctionsTest, ipPrefixFromVarChar) {
  ...
  EXPECT_THROW(ipPrefixFromVarChar("::ffff:1.2.3.4", -1), VeloxUserError);
  EXPECT_THROW(ipPrefixFromVarChar("::ffff:1.2.3.4", 33), VeloxUserError);
  EXPECT_THROW(ipPrefixFromVarChar("64:ff9b::10", -1), VeloxUserError);
  EXPECT_THROW(ipPrefixFromVarChar("64:ff9b::10", 129), VeloxUserError);
  EXPECT_THROW(ipPrefixFromVarChar("localhost", 24), VeloxUserError);
  EXPECT_THROW(ipPrefixFromVarChar("64::ff9b::10", 24), VeloxUserError);
  EXPECT_THROW(ipPrefixFromVarChar("64:face:book::10", 24), VeloxUserError);
  EXPECT_THROW(ipPrefixFromVarChar("123.456.789.012", 24), VeloxUserError);
}
