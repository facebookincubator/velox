...
class AggregateWindowBenchmark : public HiveConnectorTestBase {
 public:
  explicit AggregateWindowBenchmark() {
  ...
  ~AggregateWindowBenchmark() override {
...
std::unique_ptr<AggregateWindowBenchmark> benchmark;
...
int main(int argc, char** argv) {
  ...
  benchmark = std::make_unique<AggregateWindowBenchmark>();
  folly::runBenchmarks();
  benchmark.reset();
  return 0;
}
