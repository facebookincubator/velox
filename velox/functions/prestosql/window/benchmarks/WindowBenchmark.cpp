  ...
  void run(
    ...
    if (binarySearch) {
      plan = PlanBuilder()
                 ...
                 .windowBinarySearch({functionSql})
                 .planFragment();
...
BENCHMARK_DRAW_LINE();
BENCHMARK_NAMED_PARAM(doBinarySearch, count_k_array, "k_array", "count(1)");
BENCHMARK_NAMED_PARAM(doBinarySearch, count_k_norm, "k_norm", "count(1)");
BENCHMARK_NAMED_PARAM(doBinarySearch, count_k_hash, "k_hash", "count(1)");
BENCHMARK_DRAW_LINE();
