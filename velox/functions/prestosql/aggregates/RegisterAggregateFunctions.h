...
/// \param withCompanionFunctions : Also register companion functions, defaults to true.
/// \param onlyPrestoSignatures  : Register only function signatures that are compatible with Presto.
