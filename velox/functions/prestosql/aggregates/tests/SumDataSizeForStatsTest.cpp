...
TEST_F(SumDataSizeForStatsTest, allScalarTypes) {
  ...
  testAggregations(
      ...
      {"sum_data_size_for_stats(c1)",
       ...
       "sum_data_size_for_stats(c8)",
       "sum_data_size_for_stats(c9)"},
      "VALUES (1,2,4,8,16,8,16,2,8,32),(2,2,4,8,16,8,16,2,8,32)");
  ...
  testAggregations(
      ...
      {"sum_data_size_for_stats(c1)",
       ...
       "sum_data_size_for_stats(c8)",
       "sum_data_size_for_stats(c9)"},
      "VALUES (4,8,16,32,16,32,4,16,64)");
}
...
TEST_F(SumDataSizeForStatsTest, constantEncodingTest) {
  ...
  testAggregations(vectors, {}, {"sum_data_size_for_stats(c1)"}, "SELECT 36");

//  testAggregations(
//      vectors, {"c0"}, {"sum_data_size_for_stats(c1)"}, "VALUES (1,108),(2,108)");
}
