...
TEST_F(TypeParserTest, invalidVarcharEnums) {
  ...
  VELOX_ASSERT_THROW(
      parseType(
          "test.enum.mood:VarcharEnum(test.enum.mood{\"CURIOUS\":\"ONXW2ZKWMFWHKZI=\", \"\":\"ONXW2ZJAOZQWY5LF\"})"),
      "Failed to parse map: [[\"CURIOUS\",\"ONXW2ZKWMFWHKZI=\"], [\"\",\"ONXW2ZJAOZQWY5LF\"]], null key found");
  VELOX_ASSERT_THROW(
      parseType(
          "test.enum.mood:VarcharEnum(test.enum.mood{\"CURIOUS\":\"ONXW2ZKWMFWHKZI=\", \"HAPPY\":\"\"})"),
      "Failed to parse map: [[\"CURIOUS\",\"ONXW2ZKWMFWHKZI=\"], [\"HAPPY\",\"\"]], null value found");
