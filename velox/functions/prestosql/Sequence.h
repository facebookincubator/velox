...
template <>
inline int64_t toInt64(int8_t value) {
  return value;
}

template <>
inline int64_t toInt64(int16_t value) {
  return value;
}
...
template <>
inline int64_t toInt64(int64_t value) {
  return value;
}

template <>
inline int64_t toInt64(Timestamp value) {
...
template <>
inline int8_t add(int8_t value, int8_t step, int32_t sequence) {
  const auto delta =
...
template <>
inline int16_t add(int16_t value, int16_t step, int32_t sequence) {
  const auto delta =
      static_cast<int128_t>(step) * static_cast<int128_t>(sequence);
  return value + delta;
}
...
template <>
inline int64_t add(int64_t value, int64_t step, int32_t sequence) {
  const auto delta =
      static_cast<int128_t>(step) * static_cast<int128_t>(sequence);
...
template <>
inline int32_t add(int32_t value, int64_t step, int32_t sequence) {
  const auto delta =
      static_cast<int128_t>(step) * static_cast<int128_t>(sequence);
  return value + delta;
}
...
template <>
inline Timestamp add(Timestamp value, int64_t step, int32_t sequence) {
  const auto delta =
      static_cast<int128_t>(step) * static_cast<int128_t>(sequence);
...
template <>
inline int32_t add(int32_t value, Months step, int32_t sequence) {
  return addToDate(value, DateTimeUnit::kMonth, step * sequence);
}

template <>
inline Timestamp add(Timestamp value, Months step, int32_t sequence) {
...
inline int128_t getStepCount(int32_t start, int32_t end, int32_t step) {
  return diffDate(DateTimeUnit::kMonth, start, end) / step + 1;
}

inline int128_t getStepCount(Timestamp start, Timestamp end, int32_t step) {
