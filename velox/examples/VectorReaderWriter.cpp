...
int main() {
  ...
  // 2. Define a vector writer VectorWriter<T> where T is T is the type
  // expressed in the simple function type system.
  // ArrayWriterT is a temp holder eventually Array will be used once old
  // writers are deprecated.
  exec::VectorWriter<ArrayWriterT<Map<int64_t, int64_t>>> vectorWriter;
