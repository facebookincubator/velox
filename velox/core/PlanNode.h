...
static const SortOrder kAscNullsFirst(true, true);
static const SortOrder kAscNullsLast(true, false);
static const SortOrder kDescNullsFirst(false, true);
static const SortOrder kDescNullsLast(false, false);
