 ...
 public:
  ...
  TableWriteNode(
      ...
      : TableWriteNode(
            ...
            columns,
            columnNames,
            toColumnStatsSpecs(std::move(aggregationNode)),
  ...
  static std::optional<core::ColumnStatsSpec> toColumnStatsSpec(
    ...
    spec.groupingKeys = aggregationNode->groupingKeys();
    spec.aggregationStep = aggregationNode->step();
    for (int i = 0; i < aggregationNode->aggregateNames().size(); ++i) {
      spec.aggregateNames.emplace_back(aggregationNode->aggregateNames()[i]);
      ...
      spec.aggregates.emplace_back(aggregate);
    }
    return spec;
  }
#endif
