...
enum class SparkMapKeyDedupPolicy { LAST_WIN, EXCEPTION };
...
class QueryConfig {
 public:
  ...
  /// When set to EXCEPTION, the query fails if duplicated map keys are
  /// detected. When set to LAST_WIN, the map key that is inserted at last takes
  /// precedence.
