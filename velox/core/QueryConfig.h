...
class QueryConfig {
 public:
  ...
  static constexpr const char* kExchangeClientCloseAsyncEnabled =
      "exchange_client_close_async_enabled";
  ...
  bool exchangeClientCloseAsyncEnabled() const {
    return get<bool>(kExchangeClientCloseAsyncEnabled, false);
  }
