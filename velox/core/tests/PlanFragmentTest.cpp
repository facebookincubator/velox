...
TEST_F(PlanFragmentTest, aggregationCanSpill) {
  ...
  struct {
    AggregationNode::Aggregate::Step aggregationStep;
    bool isSpillEnabled;
    ...
    std::string debugString() const {
      ...
      {AggregationNode::Aggregate::Step::kSingle,
       ...
       false,
       true},
      {AggregationNode::Aggregate::Step::kIntermediate,
       false,
       true,
       false,
       false,
      ...
      {AggregationNode::Aggregate::Step::kIntermediate,
       ...
       false,
       false},
      {AggregationNode::Aggregate::Step::kPartial,
       false,
       true,
       false,
       false,
      ...
      {AggregationNode::Aggregate::Step::kPartial,
       ...
       false,
       false},
      {AggregationNode::Aggregate::Step::kFinal,
       false,
       true,
       false,
       false,
      ...
      {AggregationNode::Aggregate::Step::kFinal,
       ...
       false,
       false},
      {AggregationNode::Aggregate::Step::kFinal, true, true, true, false, true},
      {AggregationNode::Aggregate::Step::kFinal,
       true,
       true,
       false,
