...
const int32_t kWaitTimeoutUs = 5000'000;
...
std::shared_ptr<memory::MemoryPool> PrestoQueryReplayRunner::makeRootPool(
...
std::vector<RowVectorPtr> PrestoQueryReplayRunner::readCursor(
