...
class AsyncRPCFunction {
 public:
  ...
  ///        A function reports how it serves the instruction through
  ///        dispatchPath(). Dynamic options may require a conservative answer.
  ...
  /// Returns the backend key for rate limiting.
