...
/// the expression, the failing subexpression will be replaced with a fail
/// expression containing the error message when the argument
/// 'replaceEvalErrorWithFailExpr' is set to 'true'. Otherwise, any exception
/// encountered while optimizing the expression is suppressed.
