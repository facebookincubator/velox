...
/// Allows users to register additional expression rewrites.
...
///   - a new rewritten expression (if it didn't apply to be constant folded)
...
///   evaluation,
///     for example, if constant folding resulted in an error, for example if
///     the expression was 5/0)
///
