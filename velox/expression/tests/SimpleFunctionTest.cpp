...
template <typename T>
class ArrayOfStringsWriterFunction {
 public:
  DEFINE_FUNCTION_TYPES(T);
...
// are all null.
template <typename T>
class DefaultNullBehaviorFunction {
 public:
  DEFINE_FUNCTION_TYPES(T);
...
template <typename T>
class NonDefaultNullBehaviorFunction {
 public:
  DEFINE_FUNCTION_TYPES(T);
