...
TEST_F(ExprOptimizerTest, DISABLED_conditionals) {
  ...
  testExpression("case 1 when 2 then 32 + 1 when 1 then 34 end", "34");
  testExpression("case 1 when 2 then abs(-33) when 1 then 34 end", "34");
