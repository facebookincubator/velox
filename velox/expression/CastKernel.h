...
///
/// For logical Types (Date, Time, Decimal, etc.) the functions castFromType and
/// castToType are provided. These should handle any supported conversions
/// between core primitive Types in Velox and Type.
///
/// For physical Types (Boolean, Integer, Varchar, etc.) only the fucntion
