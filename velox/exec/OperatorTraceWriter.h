...
class OperatorTraceInputWriter : public TraceInputWriter {
 public:
...
class OperatorTraceSplitWriter : public TraceSplitWriter {
 public:
  ...
  void write(const exec::Split& split) const override;
