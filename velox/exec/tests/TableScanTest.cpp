...
DEBUG_ONLY_TEST_F(TableScanTest, batchSizeFooterEstimateFallback) {
  ...
  EXPECT_LT(batchSizesUsed[1], kDefaultBatchRows)
      << "Second split should use footer-based batch size (fallback from split 1), not default";
