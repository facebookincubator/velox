      ...
      PlanBuilder(pool_.get())
          ...
          .project(
              {"l_returnflag",
               ...
               "l_quantity",
               "l_extendedprice",
               "CAST(l_extendedprice AS DECIMAL(15,2)) * (CAST(1.0 AS DECIMAL(15,2)) - CAST(l_discount AS DECIMAL(15,2))) AS l_sum_disc_price",
               "CAST(l_extendedprice AS DECIMAL(15,2)) * (CAST(1.0 AS DECIMAL(15,2)) - CAST(l_discount AS DECIMAL(15,2))) * (CAST(1.0 AS DECIMAL(15,2)) + CAST(l_tax AS DECIMAL(15,2))) AS l_sum_charge",
               "l_discount"})
          .partialAggregation(
