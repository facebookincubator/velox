...
TpchPlan TpchQueryBuilder::getQ8Plan() const {
  ...
  std::vector<std::string> lineitemColumns = {
      "l_orderkey", "l_partkey", "l_discount", "l_extendedprice", "l_suppkey"};
  std::vector<std::string> ordersColumns = {
  ...
  auto ordersJoinCustomer = PlanBuilder(planNodeIdGenerator)
                                .tableScan(
                                    kOrders,
                                    ordersSelectedRowType,
                                    ordersFileColumns,
  ...
  auto lineitemJoinPart =
      PlanBuilder(planNodeIdGenerator)
          ...
          .hashJoin(
              ...
              part,
              "",
              {"l_suppkey", "o_orderdate", "l_extendedprice", "l_discount"})
          .planNode();
