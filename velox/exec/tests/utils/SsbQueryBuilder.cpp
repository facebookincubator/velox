...
SsbPlan SsbQueryBuilder::getQ1Plan() const {
  ...
  const auto lineorderSelectedRowType = getRowType(kLineorder, lineorderColumns);
  ...
  auto dates= PlanBuilder(planNodeIdGenerator)
                    .tableScan(
                      kDate,
                      dateSelectedRowType,
                      dateFileColumns,
  ...
  auto plan = PlanBuilder(planNodeIdGenerator)
                    ...
                    .project({"lo_extendedprice * lo_discount AS part_revenue","lo_orderdate"})
                    .hashJoin({"lo_orderdate"},{"d_datekey"},dates,"",{"part_revenue"})
...
SsbPlan SsbQueryBuilder::getQ2Plan() const {
  ...
  auto plan = PlanBuilder(planNodeIdGenerator)
                    .tableScan(
                      ...
                      lineorderFileColumns)
                    .capturePlanNodeId(lineorderPlanNodeId)
                    .filter("(lo_discount between 4 and 6) AND (lo_quantity between 26 and 35) ")
                    .project({"lo_extendedprice * lo_discount AS part_revenue","lo_orderdate"})
                    .hashJoin({"lo_orderdate"},{"d_datekey"},dates,"",{"part_revenue"})
                    .partialAggregation({},{"sum(part_revenue) as revenue"})
                    .localPartition({})
...
SsbPlan SsbQueryBuilder::getQ3Plan() const {
  ...
  auto plan = PlanBuilder(planNodeIdGenerator)
                    .tableScan(
                      ...
                      lineorderFileColumns)
                    .capturePlanNodeId(lineorderPlanNodeId)
                    .filter("(lo_discount between 5 and 7) AND (lo_quantity between 26 and 35) ")
                    .project({"lo_extendedprice * lo_discount AS part_revenue","lo_orderdate"})
                    .hashJoin({"lo_orderdate"},{"d_datekey"},dates,"",{"part_revenue"})
                    .partialAggregation({},{"sum(part_revenue) as revenue"})
                    .localPartition({})
...
SsbPlan SsbQueryBuilder::getQ4Plan() const {
  ...
  auto dates= PlanBuilder(planNodeIdGenerator)
                    ...
                    .capturePlanNodeId(datePlanNodeId)
                    .planNode();
  auto suppliers= PlanBuilder(planNodeIdGenerator)
                    .tableScan(
                      kSupplier,
                    ...
                    .planNode();  
  auto parts= PlanBuilder(planNodeIdGenerator)
                    .tableScan(
                      kPart,
                      partSelectedRowType,
                      partFileColumns,
...
SsbPlan SsbQueryBuilder::getQ7Plan() const {
  ...
  auto plan = PlanBuilder(planNodeIdGenerator)
                    ...
                    .project(
                      {"d_year","lo_revenue","s_nation","c_nation"})
                    .partialAggregation(
...
SsbPlan SsbQueryBuilder::getQ8Plan() const {
  ...
  auto plan = PlanBuilder(planNodeIdGenerator)
                    ...
                    .project(
                      {"d_year","lo_revenue","s_city","c_city"})
                    .partialAggregation(
...
SsbPlan SsbQueryBuilder::getQ11Plan() const {
  ...
  auto plan = PlanBuilder(planNodeIdGenerator)
                    ...
                    .hashJoin(
                      ...
                      dates,
                      "",
                      {"lo_revenue","lo_custkey","lo_suppkey","lo_partkey","lo_supplycost","d_year"})
                    .hashJoin(
                      {"lo_suppkey"},
                      {"s_suppkey"},
                      suppliers,
                      "",
                      {"lo_revenue","lo_custkey","lo_partkey","lo_supplycost","d_year"})
                    .hashJoin(
                      {"lo_custkey"},
                      {"c_custkey"},
                      customers,
                      "",
                      {"lo_revenue","lo_partkey","d_year","lo_supplycost","c_nation"})
                    .hashJoin(
                      {"lo_partkey"},
                      {"p_partkey"},
                      parts,
                    ...
                    .project(
                      {"d_year","c_nation","(lo_revenue-lo_supplycost) AS part_profit"})
                    .partialAggregation(
                      {"d_year","c_nation"},
...
SsbPlan SsbQueryBuilder::getQ12Plan() const {
  ...
  auto plan = PlanBuilder(planNodeIdGenerator)
                    ...
                    .hashJoin(
                      ...
                      suppliers,
                      "",
                      {"lo_revenue","lo_custkey","lo_partkey","lo_supplycost","d_year","s_nation"})
                    .hashJoin(
                      {"lo_custkey"},
                      {"c_custkey"},
                      customers,
                      "",
                      {"lo_revenue","lo_partkey","d_year","lo_supplycost","s_nation"})
                    .hashJoin(
                      {"lo_partkey"},
                      {"p_partkey"},
                      parts,
                      "",
                      {"lo_revenue","d_year","lo_supplycost","s_nation","p_category"})                      
                    .project(
                      {"d_year","s_nation","p_category","(lo_revenue-lo_supplycost) AS part_profit"})
                    .partialAggregation(
...
SsbPlan SsbQueryBuilder::getQ13Plan() const {
  ...
  auto plan = PlanBuilder(planNodeIdGenerator)
                    ...
                    .hashJoin(
                      ...
                      suppliers,
                      "",
                      {"lo_revenue","lo_custkey","lo_partkey","lo_supplycost","d_year","s_city"})
                    .hashJoin(
                      {"lo_custkey"},
                      {"c_custkey"},
                      customers,
                    ...
                    .project(
                      {"d_year","s_city","p_brand1","(lo_revenue-lo_supplycost) AS part_profit"})
                    .partialAggregation(
...
/*SsbPlan SsbQueryBuilder::getQ23Plan() const {
  std::vector<std::string> selectedColumns = {"l_orderkey","l_partkey","l_suppkey","l_linenumber","l_returnflag","l_linestatus","l_receiptdate","l_shipinstruct","l_shipmode",
      "l_shipdate", "l_extendedprice", "l_quantity", "l_discount","l_tax","l_commitdate","l_comment"};
