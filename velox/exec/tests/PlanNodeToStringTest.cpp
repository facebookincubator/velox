...
#define TOPN_PLANNODE_TO_STRING_TEST(_nodename, _functionname)                                                           \
  do {                                                                                                                   \
    auto rowType = ROW({"a", "b"}, {BIGINT(), VARCHAR()});                                                               \
    auto plan = PlanBuilder()                                                                                            \
                    .tableScan(rowType)                                                                                  \
                    ._nodename({}, {"a DESC"}, 10, false)                                                                \
                    .planNode();                                                                                         \
                                                                                                                         \
...
#undef TOPN_PLANNODE_TO_STRING_TEST
