...
int main(int argc, char** argv) {
  ...
  static const std::unordered_map<std::string, std::string>
      customVerificationFunctions = {
          ...
          {"arbitrary", ""},
          {"array_agg", "array_sort_relax({})"},
          {"array_agg_partial", "array_sort_relax({})"},
          {"array_agg_merge", "array_sort_relax({})"},
          {"array_agg_merge_extract", "array_sort_relax({})"},
          {"set_agg", "array_sort_relax({})"},
          {"set_union", "array_sort_relax({})"},
          {"map_agg", "array_sort_relax(map_keys({}))"},
          {"map_union", "array_sort_relax(map_keys({}))"},
          {"map_union_sum", "array_sort_relax(map_keys({}))"},
          {"max_by", ""},
          {"min_by", ""},
          {"map_union_sum", "array_sort_relax(map_keys({}))"},
          {"multimap_agg",
           "transform_values({}, (k, v) -> array_sort_relax(v))"},
