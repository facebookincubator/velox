...
// (2,1,2), (2,2,1), (2,3,2)) AS account (c0, c1, c2) ) SELECT c0,sum(distinct
...
// This test verifies this query:
// WITH sample AS ( SELECT * FROM (VALUES (1,1,1), (1,1,2), (1,1,100),
// (2,1,2), (2,2,1), (2,3,2)) AS account (c0, c1, c2) ) SELECT
// c0,sum(c1),sum(distinct c2) from sample group by c0;
...
// WITH sample AS ( SELECT * FROM (VALUES (1,1,1), (1,1,2), (1,1,100),
// (2,1,2), (2,2,1), (2,3,2)) AS account (c0, c1, c2) ) SELECT
// c0,sum(c1),sum(c2) from sample group by c0;
...
// This test verifies this query:
// WITH sample AS ( SELECT * FROM (VALUES (1,1,1), (1,1,2), (1,1,100),
// (1,2,2), (2,2,1), (3,2,2)) AS account (c0, c1, c2) ) SELECT c1,sum(distinct
...
// (3,21,22,23), (1,2,3,3), (2,11,13,13), (2,12,12,15), (3,21,21,21),
// (1,2,2,5), (2,13,14,15), (3,21,23,23), (3,22,23,21)) AS account (c0, c1,
// c2, c3) ) SELECT c0,sum(distinct c1),sum(distinct c2),sum(distinct c3) from
// sample group by c0;
...
// (3,21,22,23), (1,2,3,3), (2,11,13,13), (2,12,12,15), (3,21,21,21),
// (1,2,2,5), (2,13,14,15), (3,21,23,23), (3,22,23,21)) AS account (c0, c1,
// c2, c3) ) SELECT c0,sum(c1),sum(distinct c2),sum(distinct c3) from sample
// group by c0;
...
// (3,21,22,23), (1,2,3,3), (2,11,13,13), (2,12,12,15), (3,21,21,21),
// (1,2,2,5), (2,13,14,15), (3,21,23,23), (3,22,23,21)) AS account (c0, c1,
// c2, c3) ) SELECT c0,sum(distinct c1),sum(c2),sum(distinct c3) from sample
// group by c0;
...
// (3,21,22,23), (1,2,3,3), (2,11,13,13), (2,12,12,15), (3,21,21,21),
// (1,2,2,5), (2,13,14,15), (3,21,23,23), (3,22,23,21)) AS account (c0, c1,
// c2, c3) ) SELECT c0,sum(distinct c1),sum(distinct c2),sum(c3) from sample
// group by c0;
...
// (3,21,22,23), (1,2,3,3), (2,11,13,13), (2,12,12,15), (3,21,21,21),
// (1,2,2,5), (2,13,14,15), (3,21,23,23), (3,22,23,21)) AS account (c0, c1,
// c2, c3) ) SELECT c0,sum(c1),sum(c2),sum(c3) from sample group by c0;
