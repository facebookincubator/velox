...
TEST_F(PrestoQueryRunnerIntervalTransformTest, transform) {
  test(INTERVAL_DAY_TIME());
}

TEST_F(PrestoQueryRunnerIntervalTransformTest, transformArray) {
  testArray(INTERVAL_DAY_TIME());
