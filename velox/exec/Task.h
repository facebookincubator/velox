...
class FragmentExecutor {
 public:
  ...
  /// Signals that no more splits will arrive for 'planNodeId'.  Forwarded
  /// from Task::noMoreSplits().
...
class Task : public std::enable_shared_from_this<Task> {
 ...
 private:
  ...
  // claimed it; null for an ordinary task.  Destroyed early in ~Task, while
  // the pool and query context it reaches through are still held.
