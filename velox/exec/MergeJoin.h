 ...
 private:
  ...
  struct JoinTracker {
    ...
    void addMatchedRowsForRightSide(
      ...
      auto array = new vector_size_t[rows.size()];
      allocatedArrays_.push_back(array);
      rawRightMatchedRowNumbers_[outputIndex] = array;
   ...
   private:
    ...
    std::vector<vector_size_t*> allocatedArrays_;
