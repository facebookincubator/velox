...
void appendWindowFrame(const core::WindowNode::Frame& frame, std::stringstream& sql) {
  switch (frame.type) {
  ...
  auto appendBound = [&sql, &frame](const core::WindowNode::BoundType& bound, const core::TypedExprPtr& value) {
    switch (bound) {
