...
// Convert a Vector of TimestampWithTimeZone to a Vector of Varchar using
// DatetimeFormatter, so that we can get the TimestampWithTimeZone back by
// calling parse_datetime.
