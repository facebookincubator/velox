...
core::PlanNodePtr JoinMaker::makeHashJoin(
...
core::PlanNodePtr JoinMaker::makeMergeJoin(
    test::PlanBuilder& probePlan,
    test::PlanBuilder& buildPlan,
    const std::shared_ptr<JoinSource>& probeSource,
    const std::shared_ptr<JoinSource>& buildSource,
...
core::PlanNodePtr JoinMaker::makeNestedLoopJoin(
    test::PlanBuilder& probePlan,
    test::PlanBuilder& buildPlan,
    const std::shared_ptr<JoinSource>& probeSource,
    const std::shared_ptr<JoinSource>& buildSource,
...
JoinMaker::PlanWithSplits JoinMaker::makeHashJoin(
  ...
  auto probeSource = joinSources[0];
  auto buildSource = joinSources[1];
  ...
  return PlanWithSplits(makeHashJoin(
      probeSourcePlan,
      buildSourcePlan,
      probeSource,
      buildSource,
...
JoinMaker::PlanWithSplits JoinMaker::makeMergeJoin(
  ...
  return PlanWithSplits(makeMergeJoin(
      probeSourcePlan,
      buildSourcePlan,
      probeSource,
      buildSource,
...
JoinMaker::PlanWithSplits JoinMaker::makeNestedLoopJoin(
  ...
  return PlanWithSplits(makeNestedLoopJoin(
      probeSourcePlan,
      buildSourcePlan,
      probeSource,
      buildSource,
...
JoinMaker::PlanWithSplits JoinMaker::makeNestedLoopJoinWithTableScan(
  ...
  const auto plan = makeNestedLoopJoin(
      probeSourcePlan,
      buildSourcePlan,
      probeSource,
      buildSource,
