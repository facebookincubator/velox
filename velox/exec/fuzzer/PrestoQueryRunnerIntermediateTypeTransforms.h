...
class IntermediateTypeTransformBase {
 public:
  IntermediateTypeTransformBase(TypePtr intermediateType, TypePtr targetType)
      : intermediateType_(std::move(intermediateType)),
        targetType_(std::move(targetType)) {}
  virtual ~IntermediateTypeTransformBase() = default;
...
/// IntermediateTypeTransformBase, enabling conversion to and from target types
...
class IntermediateTypeTransform : public IntermediateTypeTransformBase {
 public:
  IntermediateTypeTransform(TypePtr intermediateType, TypePtr targetType)
      : IntermediateTypeTransformBase(
