...
variant TDigestTransform::transform(
    const BaseVector* const vector,
    vector_size_t row) const {
  VELOX_CHECK(isTDigestType(vector->type()));
