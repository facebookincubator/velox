...
class JoinMaker {
 public:
  ...
  enum PartitionStrategy { NONE, HASH, ROUND_ROBIN };
  ...
  enum JoinOrder { NATURAL, FLIPPED };
 ...
 private:
  ...
  core::PlanNodePtr makeMergeJoin(
      test::PlanBuilder& probePlan,
      test::PlanBuilder& buildPlan,
      const std::shared_ptr<JoinSource>& probeSource,
      const std::shared_ptr<JoinSource>& buildSource,
  ...
  core::PlanNodePtr makeNestedLoopJoin(
      test::PlanBuilder& probePlan,
      test::PlanBuilder& buildPlan,
      const std::shared_ptr<JoinSource>& probeSource,
      const std::shared_ptr<JoinSource>& buildSource,
