...
class SplitsStore {
 public:
  explicit SplitsStore(bool forTableScan) : forTableScan_(forTableScan) {}

  virtual ~SplitsStore() = default;

  /// Add a barrier split to this store.
  ///
