...
static inline void EncodeData(data_ptr_t dataptr, T value) {
  VELOX_UNSUPPORTED("Cannot create data from this type");
}

template <>
inline void EncodeData(data_ptr_t dataptr, int64_t value) {
...
static inline int
FastMemcmp(const void* str1, const void* str2, const size_t size) {
  switch (size) {
    case 0:
      return 0;
    case 1:
