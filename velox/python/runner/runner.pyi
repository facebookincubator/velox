...
def register_hive(connector_name: str) -> None: ...
def register_tpch(connector_name: str) -> None: ...
def unregister(connector_name: str) -> None: ...
def has_connector(connector_name: str) -> bool: ...
def has_connector_factory(connector_name: str) -> bool: ...
