...
TEST_F(FuzzerConnectorTest, singleSplit) {
  ...
  auto plan = tableScan(type, makeFuzzerTableHandle());
...
TEST_F(FuzzerConnectorTest, reproducible) {
  ...
  auto plan1 = tableScan(type, makeFuzzerTableHandle(/*fuzerSeed=*/1234));
  auto plan2 = tableScan(type, makeFuzzerTableHandle(/*fuzerSeed=*/1234));
