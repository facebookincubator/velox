...
class HiveConfig {
 public:
  ...
  // Flag indicating if the Parquet reader should estimate and
  // report the memory usage of deserialized Thrift objects to the memory pool.
  static constexpr const char* kParquetFooterTrackThriftMemoryEnabled =
      "hive.parquet.track-footer-thrift-memory-enabled";
