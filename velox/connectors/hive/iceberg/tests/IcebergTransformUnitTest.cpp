...
TEST_F(IcebergTransformUnitTest, testTransformsWithNulls) {
  ...
  auto transform = transforms[0];
  auto identityResult = transform.transformVector(intInput);
  ...
  auto truncateResult = transform.transformVector(decimalInput);
  ...
  transform = transforms[0];
  auto bucketResult = transform.transformVector(bigintInput);
  ...
  transform = transforms[0];
  auto yearResult = transform.transformVector(dateInput);
  ...
  transform = transforms[0];
  auto monthResult = transform.transformVector(dateInput);
  ...
  transform = transforms[0];
  auto dayResult = transform.transformVector(dateInput);
  ...
  transform = transforms[0];
  auto varcharIdentityResult = transform.transformVector(varcharInput);
  ...
  transform = transforms[0];
  auto varbinaryIdentityResult = transform.transformVector(varbinaryInput);
