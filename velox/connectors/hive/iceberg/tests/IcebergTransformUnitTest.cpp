...
class IcebergTransformUnitTest : public IcebergTestBase {
 protected:
  ...
  void testTransform(
    ...
    const auto resultVector = transform->transform(rowVector);
...
TEST_F(IcebergTransformUnitTest, testTransformsWithNulls) {
  ...
  auto transform = transforms[0];
  auto identityResult = transform->transform(rowVector);
  ...
  auto truncateResult = transform->transform(rowVector);
  ...
  transform = transforms[0];
  auto bucketResult = transform->transform(rowVector);
  ...
  transform = transforms[0];
  auto yearResult = transform->transform(rowVector);
  ...
  transform = transforms[0];
  auto monthResult = transform->transform(rowVector);
  ...
  transform = transforms[0];
  auto dayResult = transform->transform(rowVector);
  ...
  transform = transforms[0];
  auto varcharIdentityResult = transform->transform(rowVector);
  ...
  transform = transforms[0];
  auto varbinaryIdentityResult = transform->transform(rowVector);
