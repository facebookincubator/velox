 ...
 public:
  ...
  void assertEqualityDeletes(
    ...
    if (numDataColumns > 1 &&
      ...
      std::string duckDbSql1 = "SELECT c0 FROM tmp";
      if (numDeletedValues > 0) {
  ...
  IcebergDeleteFile* getEqualityDeleteFile(
      ...
      std::string duckDbSql = "") {
    deleteFilePath = writeEqualityDeleteFile(equalityDeleteVector);
    IcebergDeleteFile* deleteFile = new IcebergDeleteFile(
        FileContent::kEqualityDeletes,
