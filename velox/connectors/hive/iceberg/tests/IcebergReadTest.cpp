...
TEST_F(HiveIcebergTest, equalityDeletesSingleFileColumn1) {
  ...
  // Delete random rows
  equalityDeleteVectorMap.clear();
  equalityDeleteVectorMap.insert({0, {makeRandomDeleteValues(rowCount_)}});
  assertEqualityDeletes<TypeKind::BIGINT>(
      equalityDeleteVectorMap, equalityFieldIdsMap);
...
TEST_F(HiveIcebergTest, equalityDeletesSingleFileColumn2) {
  ...
  equalityDeleteVectorMap.insert(
      {0, {makeSequenceValues<int64_t>(rowCount_ / 2)}});
  assertEqualityDeletes<TypeKind::BIGINT>(
      equalityDeleteVectorMap, equalityFieldIdsMap);
}
...
TEST_F(HiveIcebergTest, equalityDeletesSingleFileMultipleColumns) {
  ...
  equalityDeleteVectorMap.insert(
      {0,
       {makeSequenceValues<int64_t>(rowCount_),
        makeSequenceValues<int64_t>(rowCount_, 2)}});
  assertEqualityDeletes<TypeKind::BIGINT>(
      equalityDeleteVectorMap,
      equalityFieldIdsMap,
...
TEST_F(HiveIcebergTest, equalityDeletesMultipleFiles) {
  ...
  equalityDeleteVectorMap.clear();
  equalityDeleteVectorMap.insert(
      {{0, {makeSequenceValues<int64_t>(rowCount_)}},
       {1, {makeSequenceValues<int64_t>(rowCount_)}},
       {2, {makeSequenceValues<int64_t>(rowCount_)}}});
  assertEqualityDeletes<TypeKind::BIGINT>(
      equalityDeleteVectorMap,
      equalityFieldIdsMap,
      "SELECT * FROM tmp WHERE 1 = 0");
...
TEST_F(HiveIcebergTest, equalityDeletesMixedTypesInt64Varchar) {
  folly::SingletonVault::singleton()->registrationComplete();
...
TEST_F(HiveIcebergTest, equalityDeletesMixedTypesTinyintVarbinary) {
  folly::SingletonVault::singleton()->registrationComplete();
