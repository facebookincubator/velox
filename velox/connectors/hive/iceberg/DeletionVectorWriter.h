...
/// writer collects deleted row positions and serializes them in the
/// Roaring64Bitmap portable format, compatible with Java's Roaring64Bitmap
/// used by the Presto coordinator.
///
...
/// bits. This supports files with more than 4 billion rows — necessary for
/// Meta's 500 PB scale tables.
///
/// Usage:
