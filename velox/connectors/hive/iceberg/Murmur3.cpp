...
int32_t Murmur3_32::hash(const char* const input, size_t len) {
...
int32_t Murmur3_32::hash(const StringView& value) {
  return hash(value.data(), value.size());
}

int32_t Murmur3_32::hash(uint64_t value) {
...
int32_t Murmur3_32::hashDecimal(int128_t value) {
  char bytes[16];
