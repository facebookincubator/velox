...
class HiveColumnHandle : public ColumnHandle {
 public:
  enum class ColumnType {
    ...
    kRegular,
    kSynthesized,
    /// 'kRowIndex' column type is needed,  because values for the row
    /// index meta column need to be generated by connector, instead of passed
    /// from engine. And a row index meta column is a column of type BIGINT that
    /// contains 0-based row number from a file.
    kRowIndex
  };
