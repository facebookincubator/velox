...
HiveNoCommitWriteProtocol::getWriterParameters(
  ...
  VELOX_CHECK_NOT_NULL(
      ...
      "This write protocol cannot used for non-Hive connector");
  VELOX_USER_CHECK(
  ...
  VELOX_USER_CHECK(
      hiveTableWriteHandle->isCreateTable() ||
          !connectorQueryCtx->config()->get("hive.immutable-partitions", false),
  ...
  VELOX_CHECK_EQ(
      ...
      "Hive no commit write protocol expects the write directory to be the same as the target directory.");
