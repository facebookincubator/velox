...
BENCHMARK_NAMED_PARAM(BM_HivePartFunc,
    BIGINT_10M_ROWS_1K_BUCKETS, 10'000'000, 1'000, BIGINT());

BENCHMARK_NAMED_PARAM(BM_HivePartFunc,
    BOOLEAN_10M_ROWS_1K_BUCKETS, 10'000'000, 1'000, BOOLEAN());

BENCHMARK_NAMED_PARAM(BM_HivePartFunc,
    TINYINT_10M_ROWS_1K_BUCKETS, 10'000'000, 1'000, TINYINT());

BENCHMARK_NAMED_PARAM(BM_HivePartFunc,
    SMALLINT_10M_ROWS_1K_BUCKETS, 10'000'000, 1'000, SMALLINT());

BENCHMARK_NAMED_PARAM(BM_HivePartFunc,
    INTEGER_10M_ROWS_1K_BUCKETS, 10'000'000, 1'000, INTEGER());

BENCHMARK_NAMED_PARAM(BM_HivePartFunc,
    REAL_10M_ROWS_1K_BUCKETS, 10'000'000, 1'000, REAL());

BENCHMARK_NAMED_PARAM(BM_HivePartFunc,
    DOUBLE_10M_ROWS_1K_BUCKETS, 10'000'000, 1'000, DOUBLE());

BENCHMARK_NAMED_PARAM(BM_HivePartFunc,
    TIMESTAMP_10M_ROWS_1K_BUCKETS, 10'000'000, 1'000, TIMESTAMP());

BENCHMARK_NAMED_PARAM(BM_HivePartFunc,
    DATE_10M_ROWS_1K_BUCKETS, 10'000'000, 1'000, DATE());
