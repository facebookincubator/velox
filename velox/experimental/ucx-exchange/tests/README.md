...
Run all tests:
CUDA_VISIBLE_DEVICES=7 UCX_TCP_CM_REUSEADDR=y ./_build/release/velox/experimental/ucx-exchange/tests/ucx_exchange_test -v=3 -logtostdout  

Run only a selected test:
CUDA_VISIBLE_DEVICES=7 UCX_TCP_CM_REUSEADDR=y ./_build/release/velox/experimental/ucx-exchange/tests/ucx_exchange_test -v=3 -logtostdout  --gtest_filter=UcxExchangeTest.basicTest
...
UCX_RNDV_PIPELINE_ERROR_HANDLING=y CUDA_VISIBLE_DEVICES=6 \
  ./_build/release/velox/experimental/ucx-exchange/tests/1brc_server \
...
./_build/release/velox/experimental/ucx-exchange/tests/1brc_client -v=3 --logtostdout -velox_cudf_memory_resource=async -nodes="http://sally:24356"
```
...
```
UCX_RNDV_PIPELINE_ERROR_HANDLING=y CUDA_VISIBLE_DEVICES=7 \
./_build/release/velox/experimental/ucx-exchange/tests/1brc_client \
