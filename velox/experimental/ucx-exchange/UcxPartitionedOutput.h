...
class UcxPartitionedOutput : public exec::Operator,
 ...
 public:
  ...
  // PartitionedOutput's ~10,000 row target. The process-wide default comes
  // from CudfConfig::partitionedOutputBatchRows and may be overridden per
  // query using CudfConfig::kUcxPartitionedOutputBatchRows as the QueryConfig
  // key.
