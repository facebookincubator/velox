...
std::shared_ptr<Communicator> Communicator::initAndGet(
  ...
  std::call_once(onceFlag, [&] {
    ...
    LOG(INFO) << "cudf-exchange VLOG level set to " << logLevel;
    if (logLevel > 0) {
      // Set VLOG level for all cudf-exchange source files.
      // kCudfExchangeModules is auto-generated by CMake from the source list.
      for (const char* module : kCudfExchangeModules) {
