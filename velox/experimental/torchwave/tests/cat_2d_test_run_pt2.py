...
import torch
from velox.experimental.torchwave.tests.cat_2d_test import Cat2dTest
...
def main() -> None:
    ...
    parser.add_argument(
        "--output_dir",
        default=default_dir,
        help="Directory to write cat_2d_test.pt2 and cat_2d_test_results.pt",
    )
    ...
    for i, r in enumerate(results):
        ...
        print(f"       first row first 10: {r[0, :10].tolist()}")

    results_path = os.path.join(output_dir, "cat_2d_test_results.pt")
    ...
    pt2_path = os.path.join(output_dir, "cat_2d_test.pt2")
