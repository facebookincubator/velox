...
import torch
from velox.experimental.torchwave.tests.cumsum_test import CumsumTestPreproc
...
def main() -> None:
    ...
    parser.add_argument(
        "--output_dir",
        default=default_dir,
        help="Directory to write cumsum_test.pt2 and cumsum_test_results.pt",
    )
    ...
    # Save eager results.
    results_path = os.path.join(output_dir, "cumsum_test_results.pt")
    ...
    # Save as .pt2.
    pt2_path = os.path.join(output_dir, "cumsum_test.pt2")
