...
import torch
from velox.experimental.torchwave.tests.cat_2d_reuse_test import Cat2dReuseTest
...
def main() -> None:
    ...
    c = torch.randn(100, 50)
    d = torch.randn(100, 30)
    inputs = (a, b, c, d)

    module = Cat2dReuseTest()
    ...
    results_path = os.path.join(output_dir, "cat_2d_reuse_test_results.pt")
    ...
    pt2_path = os.path.join(output_dir, "cat_2d_reuse_test.pt2")
