...
import torch
from velox.experimental.torchwave.tests.stack_nd_test import StackNdTest
...
def main() -> None:
    ...
    results_path = os.path.join(output_dir, "stack_nd_test_results.pt")
    ...
    pt2_path = os.path.join(output_dir, "stack_nd_test.pt2")
