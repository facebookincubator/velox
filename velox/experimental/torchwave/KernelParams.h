...
struct Tensor {
  ...
  // Index calculator dividers, initialized on device via initIndexCalculator().
  IntDivider sizes[kMaxDims];

#ifdef __CUDACC__
  /// Initializes IntDivider magic numbers from dims.
  __device__ void initIndexCalculator() {
