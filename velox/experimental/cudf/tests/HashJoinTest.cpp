...
class CudfHashJoinTest : public HiveConnectorTestBase {
 protected:
  CudfHashJoinTest() : CudfHashJoinTest(TestParam(1)) {}

  explicit CudfHashJoinTest(const TestParam& param)
...
class MultiThreadedCudfHashJoinTest
    : public CudfHashJoinTest,
      public testing::WithParamInterface<TestParam> {
 public:
  MultiThreadedCudfHashJoinTest() : CudfHashJoinTest(GetParam()) {}
...
TEST_P(MultiThreadedCudfHashJoinTest, bigintArray) {
...
// TEST_P(MultiThreadedCudfHashJoinTest, outOfJoinKeyColumnOrder) {
//   HashJoinBuilder(*pool_, duckDbQueryRunner_, driverExecutor_.get())
//       .numDrivers(numDrivers_)
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, emptyBuild) {
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, emptyProbe) {
//   HashJoinBuilder(*pool_, duckDbQueryRunner_, driverExecutor_.get())
//       .numDrivers(numDrivers_)
//       .keyTypes({BIGINT()})
//       .probeVectors(0, 5)
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, normalizedKey) {
//   HashJoinBuilder(*pool_, duckDbQueryRunner_, driverExecutor_.get())
//       .numDrivers(numDrivers_)
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, normalizedKeyOverflow) {
//   HashJoinBuilder(*pool_, duckDbQueryRunner_, driverExecutor_.get())
...
// }
//
// DEBUG_ONLY_TEST_P(MultiThreadedCudfHashJoinTest, parallelJoinBuildCheck) {
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, allTypes) {
//   HashJoinBuilder(*pool_, duckDbQueryRunner_, driverExecutor_.get())
//       .keyTypes(
//           {BIGINT(),
//            VARCHAR(),
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, filter) {
//   HashJoinBuilder(*pool_, duckDbQueryRunner_, driverExecutor_.get())
//       .numDrivers(numDrivers_)
//       .keyTypes({BIGINT()})
//       .probeVectors(1600, 5)
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, nullAwareAntiJoinWithNull) {
//   struct {
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, rightSemiJoinFilterWithLargeOutput) {
...
// TEST_P(MultiThreadedCudfHashJoinTest, arrayBasedLookup) {
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, joinSidesDifferentSchema) {
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, innerJoinWithEmptyBuild) {
//   const std::vector<bool> finishOnEmptys = {false, true};
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, leftSemiJoinFilter) {
//   HashJoinBuilder(*pool_, duckDbQueryRunner_, driverExecutor_.get())
//       .numDrivers(numDrivers_)
//       .probeType(probeType_)
//       .probeVectors(174, 5)
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, leftSemiJoinFilterWithEmptyBuild) {
//   const std::vector<bool> finishOnEmptys = {false, true};
//   for (const auto finishOnEmpty : finishOnEmptys) {
//     SCOPED_TRACE(fmt::format("finishOnEmpty: {}", finishOnEmpty));
//
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, leftSemiJoinFilterWithExtraFilter) {
//   std::vector<RowVectorPtr> probeVectors = makeBatches(5, [&](int32_t batch) {
//     return makeRowVector(
//         {"t0", "t1"},
//         {
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, rightSemiJoinFilter) {
//   HashJoinBuilder(*pool_, duckDbQueryRunner_, driverExecutor_.get())
//       .numDrivers(numDrivers_)
//       .probeType(probeType_)
//       .probeVectors(133, 3)
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, rightSemiJoinFilterWithEmptyBuild) {
//   const std::vector<bool> finishOnEmptys = {false, true};
//   for (const auto finishOnEmpty : finishOnEmptys) {
//     SCOPED_TRACE(fmt::format("finishOnEmpty: {}", finishOnEmpty));
//
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, rightSemiJoinFilterWithAllMatches) {
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, rightSemiJoinFilterWithExtraFilter) {
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, semiFilterOverLazyVectors) {
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, nullAwareAntiJoin) {
//   std::vector<RowVectorPtr> probeVectors =
//       makeBatches(5, [&](uint32_t /*unused*/) {
//         return makeRowVector({
//             makeFlatVector<int32_t>(
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, nullAwareAntiJoinWithFilter) {
//   std::vector<RowVectorPtr> probeVectors =
//       makeBatches(5, [&](int32_t /*unused*/) {
//         return makeRowVector(
//             {"t0", "t1"},
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, nullAwareAntiJoinWithFilterAndEmptyBuild) {
//   const std::vector<bool> finishOnEmptys = {false, true};
//   for (const auto finishOnEmpty : finishOnEmptys) {
//     SCOPED_TRACE(fmt::format("finishOnEmpty: {}", finishOnEmpty));
//
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, nullAwareAntiJoinWithFilterAndNullKey) {
//   auto probeVectors = makeBatches(4, [&](int32_t /*unused*/) {
//     return makeRowVector(
//         {"t0", "t1"},
//         {
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, nullAwareAntiJoinWithFilterOnNullableColumn) {
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, antiJoin) {
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, antiJoinWithFilterAndEmptyBuild) {
//   const std::vector<bool> finishOnEmptys = {false, true};
//   for (const auto finishOnEmpty : finishOnEmptys) {
//     SCOPED_TRACE(fmt::format("finishOnEmpty: {}", finishOnEmpty));
//
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, leftJoin) {
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, nullStatsWithEmptyBuild) {
//   std::vector<RowVectorPtr> probeVectors =
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, leftJoinWithEmptyBuild) {
//   const std::vector<bool> finishOnEmptys = {false, true};
//   for (const auto finishOnEmpty : finishOnEmptys) {
//     SCOPED_TRACE(fmt::format("finishOnEmpty: {}", finishOnEmpty));
//
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, leftJoinWithNoJoin) {
//   // Left side keys are [0, 1, 2,..10].
//   // Use 3-rd column as row number to allow for asserting the order of
//   // results.
//   std::vector<RowVectorPtr> probeVectors = mergeBatches(
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, leftJoinWithAllMatch) {
//   // Left side keys are [0, 1, 2,..10].
//   // Use 3-rd column as row number to allow for asserting the order of
//   // results.
//   std::vector<RowVectorPtr> probeVectors = mergeBatches(
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, leftJoinWithFilter) {
//   // Left side keys are [0, 1, 2,..10].
//   // Use 3-rd column as row number to allow for asserting the order of
//   // results.
//   std::vector<RowVectorPtr> probeVectors = mergeBatches(
...
// TEST_P(MultiThreadedCudfHashJoinTest, leftJoinWithNullableFilter) {
//   std::vector<RowVectorPtr> probeVectors = mergeBatches(
//       makeBatches(
//           5,
//           [&](int32_t /*unused*/) {
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, rightJoin) {
//   // Left side keys are [0, 1, 2,..20].
//   std::vector<RowVectorPtr> probeVectors = mergeBatches(
//       makeBatches(
//           3,
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, rightJoinWithEmptyBuild) {
//   const std::vector<bool> finishOnEmptys = {false, true};
//   for (const auto finishOnEmpty : finishOnEmptys) {
//     SCOPED_TRACE(fmt::format("finishOnEmpty: {}", finishOnEmpty));
//
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, rightJoinWithAllMatch) {
//   // Left side keys are [0, 1, 2,..20].
//   std::vector<RowVectorPtr> probeVectors = mergeBatches(
//       makeBatches(
//           3,
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, rightJoinWithFilter) {
//   // Left side keys are [0, 1, 2,..20].
//   std::vector<RowVectorPtr> probeVectors = mergeBatches(
//       makeBatches(
//           3,
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, fullJoin) {
//   // Left side keys are [0, 1, 2,..20].
//   std::vector<RowVectorPtr> probeVectors = mergeBatches(
//       makeBatches(
//           3,
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, fullJoinWithEmptyBuild) {
//   const std::vector<bool> finishOnEmptys = {false, true};
//   for (const auto finishOnEmpty : finishOnEmptys) {
//     SCOPED_TRACE(fmt::format("finishOnEmpty: {}", finishOnEmpty));
//
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, fullJoinWithNoMatch) {
//   // Left side keys are [0, 1, 2,..10].
//   std::vector<RowVectorPtr> probeVectors = mergeBatches(
//       makeBatches(
//           3,
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, fullJoinWithFilters) {
//   // Left side keys are [0, 1, 2,..10].
//   std::vector<RowVectorPtr> probeVectors = mergeBatches(
//       makeBatches(
//           3,
...
// }
//
// TEST_P(MultiThreadedCudfHashJoinTest, noSpillLevelLimit) {
//   HashJoinBuilder(*pool_, duckDbQueryRunner_, driverExecutor_.get())
//       .numDrivers(numDrivers_)
//       .keyTypes({INTEGER()})
//       .probeVectors(1600, 5)
...
// TEST_F(CudfHashJoinTest, nullAwareRightSemiProjectOverScan) {
...
// }
//
// TEST_F(CudfHashJoinTest, duplicateJoinKeys) {
...
// }
//
// TEST_F(CudfHashJoinTest, semiProject) {
...
// }
//
// TEST_F(CudfHashJoinTest, semiProjectWithNullKeys) {
//   // Some keys have multiple rows: 2, 3, 5.
//   auto probeVectors = makeBatches(3, [&](int32_t /*unused*/) {
//     return makeRowVector(
//         {"t0", "t1"},
...
// }
//
// TEST_F(CudfHashJoinTest, semiProjectWithFilter) {
...
// }
//
// TEST_F(CudfHashJoinTest, nullAwareRightSemiProjectWithFilterNotAllowed) {
...
// }
//
// TEST_F(CudfHashJoinTest, nullAwareMultiKeyNotAllowed) {
//   auto probe = makeRowVector(
...
// }
//
// TEST_F(CudfHashJoinTest, semiProjectOverLazyVectors) {
//   auto probeVectors = makeBatches(1, [&](auto /*unused*/) {
//     return makeRowVector(
//         {"t0", "t1"},
//         {
...
VELOX_INSTANTIATE_TEST_SUITE_P(
    CudfHashJoinTest,
    MultiThreadedCudfHashJoinTest,
    testing::ValuesIn(MultiThreadedCudfHashJoinTest::getTestParams()));

// // TODO: try to parallelize the following test cases if possible.
// TEST_F(CudfHashJoinTest, memory) {
...
// }
//
// TEST_F(CudfHashJoinTest, lazyVectors) {
...
// }
//
// TEST_F(CudfHashJoinTest, dynamicFilters) {
...
// }
//
// TEST_F(CudfHashJoinTest, dynamicFiltersWithSkippedSplits) {
...
// }
//
// TEST_F(CudfHashJoinTest, dynamicFiltersAppliedToPreloadedSplits) {
...
// TEST_F(CudfHashJoinTest, memoryUsage) {
//   std::vector<RowVectorPtr> probeVectors =
//       makeBatches(10, [&](int32_t /*unused*/) {
//         return makeRowVector(
...
// /// triggering a crash.
// TEST_F(CudfHashJoinTest, smallOutputBatchSize) {
...
// }
//
// TEST_F(CudfHashJoinTest, spillFileSize) {
...
// }
//
// TEST_F(CudfHashJoinTest, spillPartitionBitsOverlap) {
//   auto builder =
//       HashJoinBuilder(*pool_, duckDbQueryRunner_, driverExecutor_.get())
//           .numDrivers(numDrivers_)
...
// // task error.
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, buildReservationReleaseCheck) {
//   std::vector<RowVectorPtr> probeVectors =
//       makeBatches(1, [&](int32_t /*unused*/) {
//         return std::dynamic_pointer_cast<RowVector>(
//             BatchMaker::createBatch(probeType_, 1000, *pool_));
...
// }
//
// TEST_F(CudfHashJoinTest, dynamicFilterOnPartitionKey) {
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, reclaimDuringInputProcessing) {
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, reclaimDuringReserve) {
//   constexpr int64_t kMaxBytes = 1LL << 30; // 1GB
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, reclaimDuringAllocation) {
//   constexpr int64_t kMaxBytes = 1LL << 30; // 1GB
//   VectorFuzzer fuzzer({.vectorSize = 1000}, pool());
//   const int32_t numBuildVectors = 10;
//   std::vector<RowVectorPtr> buildVectors;
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, reclaimDuringOutputProcessing) {
//   constexpr int64_t kMaxBytes = 1LL << 30; // 1GB
//   VectorFuzzer fuzzer({.vectorSize = 1000}, pool());
//   const int32_t numBuildVectors = 10;
//   std::vector<RowVectorPtr> buildVectors;
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, reclaimDuringWaitForProbe) {
//   constexpr int64_t kMaxBytes = 1LL << 30; // 1GB
//   VectorFuzzer fuzzer({.vectorSize = 1000}, pool());
//   const int32_t numBuildVectors = 10;
//   std::vector<RowVectorPtr> buildVectors;
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, hashBuildAbortDuringOutputProcessing) {
//   constexpr int64_t kMaxBytes = 1LL << 30; // 1GB
//   VectorFuzzer fuzzer({.vectorSize = 1000}, pool());
//   const int32_t numBuildVectors = 10;
//   std::vector<RowVectorPtr> buildVectors;
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, hashBuildAbortDuringInputProcessing) {
//   constexpr int64_t kMaxBytes = 1LL << 30; // 1GB
//   VectorFuzzer fuzzer({.vectorSize = 1000}, pool());
//   const int32_t numBuildVectors = 10;
//   std::vector<RowVectorPtr> buildVectors;
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, hashProbeAbortDuringInputProcessing) {
//   constexpr int64_t kMaxBytes = 1LL << 30; // 1GB
//   VectorFuzzer fuzzer({.vectorSize = 1000}, pool());
//   const int32_t numBuildVectors = 10;
//   std::vector<RowVectorPtr> buildVectors;
...
// }
//
// TEST_F(CudfHashJoinTest, leftJoinWithMissAtEndOfBatch) {
...
// }
//
// TEST_F(CudfHashJoinTest, leftJoinWithMissAtEndOfBatchMultipleBuildMatches) {
//   // Tests some cases where the row at the end of an output batch fails the
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, minSpillableMemoryReservation) {
//   constexpr int64_t kMaxBytes = 1LL << 30; // 1GB
//   VectorFuzzer fuzzer({.vectorSize = 1000}, pool());
//   const int32_t numBuildVectors = 10;
//   std::vector<RowVectorPtr> buildVectors;
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, exceededMaxSpillLevel) {
//   VectorFuzzer fuzzer({.vectorSize = 1000}, pool());
//   const int32_t numBuildVectors = 10;
//   std::vector<RowVectorPtr> buildVectors;
//   for (int32_t i = 0; i < numBuildVectors; ++i) {
...
// }
//
// TEST_F(CudfHashJoinTest, maxSpillBytes) {
//   const auto rowType =
...
// }
//
// TEST_F(CudfHashJoinTest, onlyHashBuildMaxSpillBytes) {
//   const auto rowType =
//       ROW({"c0", "c1", "c2"}, {INTEGER(), INTEGER(), VARCHAR()});
...
// }
//
// TEST_F(CudfHashJoinTest, reclaimFromJoinBuilderWithMultiDrivers) {
//   auto rowType = ROW({
//       {"c0", INTEGER()},
//       {"c1", INTEGER()},
//       {"c2", VARCHAR()},
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, reclaimFromHashJoinBuildInWaitForTableBuild) {
//   std::unique_ptr<memory::MemoryManager> memoryManager = createMemoryManager();
//   const auto& arbitrator = memoryManager->arbitrator();
//   auto rowType = ROW({
//       {"c0", INTEGER()},
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, arbitrationTriggeredDuringParallelJoinBuild) {
//   std::unique_ptr<memory::MemoryManager> memoryManager = createMemoryManager();
//   const auto& arbitrator = memoryManager->arbitrator();
//   auto rowType = ROW({
//       {"c0", INTEGER()},
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, arbitrationTriggeredByEnsureJoinTableFit) {
//   std::unique_ptr<memory::MemoryManager> memoryManager = createMemoryManager();
//   const auto& arbitrator = memoryManager->arbitrator();
//   auto rowType = ROW({
//       {"c0", INTEGER()},
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, reclaimDuringJoinTableBuild) {
//   std::unique_ptr<memory::MemoryManager> memoryManager = createMemoryManager();
//   const auto& arbitrator = memoryManager->arbitrator();
//   auto rowType = ROW({
//       {"c0", INTEGER()},
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, joinBuildSpillError) {
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, taskWaitTimeout) {
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, hashProbeSpill) {
//   struct {
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, hashProbeSpillInMiddeOfLastOutputProcessing) {
...
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, hashProbeSpillInMiddeOfOutputProcessing) {
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, hashProbeSpillWhenOneOfProbeFinish) {
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, hashProbeSpillExceedLimit) {
...
// }
//
// DEBUG_ONLY_TEST_F(CudfHashJoinTest, hashProbeSpillUnderNonReclaimableSection) {
//   std::atomic_bool injectOnce{true};
//   SCOPED_TESTVALUE_SET(
//       "facebook::velox::common::memory::MemoryPoolImpl::allocateNonContiguous",
//       std::function<void(memory::MemoryPool*)>([&](memory::MemoryPool* pool) {
