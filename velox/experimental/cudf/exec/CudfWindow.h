...
/// Supports partition-wide DECIMAL AVG for OVER () and OVER (PARTITION BY ...)
/// using cuDF's optimized fully unbounded rolling path. With ORDER BY, the
/// frame must explicitly cover the entire partition.
