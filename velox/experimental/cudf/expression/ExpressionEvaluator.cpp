...
// Registers the Presto date_add GPU function under the given prefix.
// Defined here, rather than in PrestoFunctions.cpp, because
// PrestoDateAddFunction and its helpers depend on file-local machinery of
// ExpressionEvaluator.cpp (e.g. makeScalarFromConstantExpr). PrestoFunctions.cpp
// invokes this from registerPrestoFunctions().
