...
struct RPCResponse {
  ...
  /// here. An error response carries none, and states so explicitly: a
  /// designated initializer that steps over this member trips
  /// -Wmissing-field-initializers on some GCC 11 point releases even though it
  /// is default-initialized here.
