...
constexpr folly::StringPiece kMetricMemoryPoolLeakUsedBytes{
    "velox.memory_pool_leak_used_bytes"};

constexpr folly::StringPiece kMetricMemoryPoolLeakMinBytes{
    "velox.memory_pool_leak_min_bytes"};
