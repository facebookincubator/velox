...
///
/// Include this header in .h files. Include Enums.h only in .cpp files that use
/// the DEFINE macros. Enums.h pulls in heavy transitive includes
...
///
/// #include "velox/common/EnumsDeclare.h"
///
/// enum class Foo {...};
///
