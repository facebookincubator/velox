...
class ReadFile {
 public:
  ...
  virtual std::string_view pread(
      ...
      uint64_t length,
      void* buf,
      filesystems::FileSystemStatistics* stats = nullptr) const = 0;
  ...
  virtual std::string pread(
      uint64_t offset,
      uint64_t length,
      filesystems::FileSystemStatistics* stats = nullptr) const;
...
class InMemoryReadFile : public ReadFile {
 public:
  ...
  std::string_view pread(
      ...
      uint64_t length,
      void* buf,
      filesystems::FileSystemStatistics* stats = nullptr) const override;

  std::string pread(
      uint64_t offset,
      uint64_t length,
      filesystems::FileSystemStatistics* stats) const override;
...
class LocalReadFile final : public ReadFile {
 public:
  ...
  std::string_view pread(
      ...
      uint64_t length,
      void* buf,
      filesystems::FileSystemStatistics* stats = nullptr) const final;
