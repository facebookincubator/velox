...
/// values are int64_t. The underlying filesystem implementation can use this
/// class to record observability about filesystem operations.
class FileSystemStatistics {
 public:
  ...
  void merge(const FileSystemStatistics& other) {
