...
TEST_F(CopyPreserveEncodingsTest, biasHasNulls) {
  ...
  validateCopyPreserveEncodings(
      biasVector, biasVector->copyPreserveEncodings());
}
...
TEST_F(CopyPreserveEncodingsTest, arrayHasNulls) {
  ...
  validateCopyPreserveEncodings(
      arrayVector, arrayVector->copyPreserveEncodings());
}
...
TEST_F(CopyPreserveEncodingsTest, mapHasNulls) {
  ...
  validateCopyPreserveEncodings(mapVector, mapVector->copyPreserveEncodings());
}
...
TEST_F(CopyPreserveEncodingsTest, rowHasNulls) {
  ...
  validateCopyPreserveEncodings(rowVector, rowVector->copyPreserveEncodings());
}
...
TEST_F(CopyPreserveEncodingsTest, constantNull) {
  ...
  validateCopyPreserveEncodings(
      constantVector, constantVector->copyPreserveEncodings());
}
...
TEST_F(CopyPreserveEncodingsTest, dictionaryHasNulls) {
  ...
  validateCopyPreserveEncodings(
      dictionaryVector, dictionaryVector->copyPreserveEncodings());
}
...
TEST_F(CopyPreserveEncodingsTest, flatHasNulls) {
  ...
  validateCopyPreserveEncodings(
      flatVector, flatVector->copyPreserveEncodings());
}
...
TEST_F(CopyPreserveEncodingsTest, sequenceHasNulls) {
  ...
  validateCopyPreserveEncodings(
      sequenceVector, sequenceVector->copyPreserveEncodings());
}
