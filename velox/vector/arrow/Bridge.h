...
/// Export the type of Velox vector to an ArrowSchema.
///
...
///
/// NOTE: Since Velox type does not consider dictionary-encoding, you need to
/// use the vector which contains encoding information to generate the arrow
/// type.
