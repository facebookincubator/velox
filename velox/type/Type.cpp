...
const std::shared_ptr<const VarcharType> VarcharType::create() {
  static const auto instance =
      std::make_shared<const VarcharType>(VarcharType::kUnboundedLength);
  return instance;
}

template <>
const std::shared_ptr<const VarcharType> VarcharType::create(uint32_t length) {
...
const std::shared_ptr<const VarbinaryType> VarbinaryType::create() {
  static const auto instance =
      std::make_shared<const VarbinaryType>(VarbinaryType::kUnboundedLength);
  return instance;
}
