...
/// Returns true iff the value is null. Supports all data types.
...
/// Returns true iff the value is not null. Supports all data types.
...
class BoolValue final : public Filter {
 public:
  ...
  /// values that are not null are passing as well.
