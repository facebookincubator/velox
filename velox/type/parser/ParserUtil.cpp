...
std::map<std::string, int64_t> parseMapFromString(const std::string& input) {
  // Wrap with braces to make valid JSON
...
TypePtr getEnumType(
  ...
  params.emplace_back(TypeParameter(parseMapFromString(map)));
