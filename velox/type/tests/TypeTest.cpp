...
TEST(TypeTest, equivalent) {
  ...
  EXPECT_TRUE(VARCHAR(10)->equivalent(*VARCHAR(kVaryingLengthScalarTypeUnboundedLength)));
  EXPECT_FALSE(VARCHAR(kVaryingLengthScalarTypeUnboundedLength)->equivalent(*VARCHAR(10)));
