...
TEST(TimestampTest, skipTrailingZeroSeconds) {
  ...
  ASSERT_EQ(
      ...
      "2000-01-01 12:21:56.129");
  ASSERT_EQ(
      timestampToString(Timestamp(946729316, 100000000), options),
      "2000-01-01 12:21:56.1");
  ASSERT_EQ(
      timestampToString(Timestamp(946729310, 0), options),
      "2000-01-01 12:21:50");
  ASSERT_EQ(
  ...
  ASSERT_EQ(
      ...
      "0384-01-01 08:00:00.7266");
  ASSERT_EQ(
      timestampToString(Timestamp(-50049331200, 100000000), options),
      "0384-01-01 08:00:00.1");
}
