...
TEST(HugeIntTest, combine) {
  ...
  testCombine(INT64_MAX, 0, "9223372036854775807000000000000000000");
  testCombine(INT64_MIN, 0, "-9223372036854775808000000000000000000");
  testCombine(INT64_MAX, INT64_MAX, "9223372036854775816223372036854775807");
  testCombine(INT64_MIN, INT64_MIN, "-9223372036854775817223372036854775808");
