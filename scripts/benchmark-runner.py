...
# TODO: Add "--bm_epochs 100000" and remove "--json" when folly is updated.
_BENCHMARK_CMD = "%s --bm_max_secs 10"
_BENCHMARK_WITH_DUMP_CMD = _BENCHMARK_CMD + " --bm_json_verbose %s --json"
