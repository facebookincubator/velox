...
MACOS_VELOX_DEPS="bison double-conversion fast_float flex fmt gflags glog googletest icu4c libevent libsodium lz4 openssl protobuf@21 simdjson snappy xz xxhash zstd"
