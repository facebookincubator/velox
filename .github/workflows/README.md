...
- Push to `main` → full
- PR with a standing approving review on the current head SHA → full
- PR where any commenter has posted `/full-build` → full
