...
set(ENV{VCToolsInstallDir_170} "${VCPP_TOOLS_PKG_DIR}/lib/native/")
...
# Compiler flags - use INCLUDE env var for include paths (set above)
# Do NOT use /I flags in VCPKG_CXX_FLAGS as the quoting gets mangled by
# Ninja when vcpkg builds ports internally.
set(VCPKG_CXX_FLAGS "")
...
message(STATUS "Using NuGet MSVC Toolset ${VCTOOLS_VERSION} with DYNAMIC CRT (/MD)")
