---
name: query
description: Answer questions about the Velox codebase or pull requests. Use when asked a question via "/pr-query" or when the user wants to understand code, architecture, or implementation details.
---
