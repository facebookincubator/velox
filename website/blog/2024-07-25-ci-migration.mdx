...
3. Ensure Velox builds under its various configurations
    ...
    3. Build Velox with support for Parquet, Arrowm and External Adapters (S3/HDFS/GCS etc.)
    4. PyVelox builds
