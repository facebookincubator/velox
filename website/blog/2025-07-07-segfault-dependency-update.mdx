...
Looking around further, we noticed that the ServiceHandlerBase was conditionally adding functions based on the fcoroutines flag that influences the FOLLY_HAS_COROUTINES macro from the portability header.
