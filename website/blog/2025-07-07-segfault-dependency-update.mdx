...
We were also curious about the invocation of the destructor instead of the actual function. We wore our gdb gloves again and dumped the entire
...
We recompiled the Facebook Thrift dependency for Velox with the *coroutines* flag disabled, and the test passed.
